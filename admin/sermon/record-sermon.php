...
<style>
  ...
  .session-indicator .session-stats {
  ...
  .btn-save-slides.show {
    display: inline-block;
  }

  .btn-save-slides:hover {
    transform: translateY(-2px);
...
<script>
// Enhanced JavaScript for record-sermon.php - SEAMLESS RECORDING VERSION
